...
#define IMX274_DEF_FRAME_RATE			(30)
...
static const struct reg_8 imx179_mode1_3280x2464_raw10[] = {
	...
	{ 0x0401, 0x00 },
	{ 0x0404, 0x00 },
	{ 0x0405, 0x10 }, /* down scaling 16/16 = 1 */
	{ 0x4082, 0x01 },
	{ 0x4083, 0x01 },
	{ 0x7006, 0x04 },
	...
	/* Size setting */
	{ 0x0344, 0x00 },      /*	x_addr_start[15:8]:0	*/
	{ 0x0345, 0x00 },      /*	x_addr_start[7:0]	*/
	{ 0x0346, 0x00 },      /*	y_addr_start[15:8]:0	*/
	{ 0x0347, 0x00 },      /*	y_addr_start[7:0]	*/
	{ 0x0348, 0x0C },      /*	x_addr_end[15:8]:3279	*/
	{ 0x0349, 0xCF },      /*	x_addr_end[7:0]		*/
	{ 0x034A, 0x09 },      /*	y_addr_end[15:8]:2463	*/
	{ 0x034B, 0x9F },      /*	y_addr_end[7:0]		*/
	{ 0x034C, 0x0C },      /*	x_output_size[15:8]: 3280*/
	{ 0x034D, 0xD0 },      /*	x_output_size[7:0]	*/
	{ 0x034E, 0x09 },      /*	y_output_size[15:8]:2464 */
