 ...
 *
 * For example, the Nintendo Wii U video game console is unable to perform
...
#define	OHCI_QUIRK_WIIU		0x2000			/* Wii U chipset */
...
extern void ohci_wiiu_control_quirk(struct ohci_hcd *ohci);
extern void ohci_wiiu_bulk_quirk(struct ohci_hcd *ohci);

#else

static inline void ohci_wiiu_control_quirk(struct ohci_hcd *ohci)
{
	return;
}

static inline void ohci_wiiu_bulk_quirk(struct ohci_hcd *ohci)
{
	return;
}
...
#endif /* CONFIG_USB_OHCI_HCD_WIIU */
